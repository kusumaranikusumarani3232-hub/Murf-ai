...
# Add the backend root directory to sys.path to resolve src imports
import sys
from os import path
sys.path.append(path.abspath(path.join(path.dirname(__file__), "..", "..", "..")))

from src.agent import Assistant as MainAssistant
...
GREETING = "Hello, I am your English Learning Coach. Do you have a moment to practice your English today?"

# The identity LiveKit gives the person we call. Used to transfer them later.
CALLEE_IDENTITY = "phone-user"


class OutboundAgent(MainAssistant):
